            ...
            <div className="border-b sticky top-0 z-10 flex justify-center border-t w-full bg-black border-neutral-700/60 border-dashed">
                <div className="w-full max-w-full">
                    <div className="flex px-10 py-3 flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <Link href="/">
                            <div className="flex items-center gap-2 min-w-[14rem] justify-center md:justify-start">
                                <div className="w-10 h-10 rounded-2xl bg-neutral-800 flex items-center justify-center border border-neutral-700">
                ...
                {filteredCards.length > 0 &&
                    filteredCards.map((card) => (
                        <Link href={`/card/${card.card_id}`} key={card.card_id}>
                            <div className="relative flex flex-col md:flex-row items-stretch bg-black border-b border-t border-dashed border-neutral-700/60 shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-neutral-950/90 hover:shadow-2xl group mt-6 backdrop-blur-sm hover:border-neutral-600/70">
                                ...
                                <div className="relative w-full flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-6 bg-black p-4 md:p-6 md:w-72 backdrop-blur-sm border-r border-neutral-700/40">
                                    ...
                                    <div className="relative w-full z-10">
                                        ...
                                        <div className="flex flex-wrap text-nowrap items-start gap-2">
                                            ...
                                            <span className={clsx(
                                                ...
                                                card.category.toLowerCase() === 'premium' && 'bg-gradient-to-r from-yellow-400/70 to-yellow-500/80 border-yellow-400 text-yellow-950 shadow-yellow-400/40 hover:shadow-yellow-500/60 ',
                                                card.category.toLowerCase() === 'super premium' && 'bg-gradient-to-r from-purple-500/70 to-purple-600/80 border-purple-400 text-purple-200 shadow-purple-400/40 hover:shadow-purple-500/60',
                                                card.category.toLowerCase() === 'entry level' && 'bg-gradient-to-r from-blue-400/70 to-blue-500/80 border-blue-400 text-blue-950 shadow-blue-400/40 hover:shadow-blue-500/60',
                                                card.category.toLowerCase() === 'cashback' && 'bg-gradient-to-r from-green-400/70 to-emerald-500/80 border-green-400 text-green-950 shadow-green-400/40 hover:shadow-green-500/60',
                                                card.category.toLowerCase() === 'rewards' && 'bg-gradient-to-r from-orange-400/70 to-amber-500/80 border-orange-400 text-orange-950 shadow-orange-400/40 hover:shadow-orange-500/60 ',
                                                card.category.toLowerCase() === 'lifetime free' && 'bg-gradient-to-r from-red-400/70 to-red-500/80 border-red-400 text-red-950 shadow-slate-400/40 hover:shadow-red-500/60',
                                                card.category.toLowerCase() === 'travel' && 'bg-gradient-to-r from-teal-400/70 to-cyan-500/80 border-teal-400 text-teal-950 shadow-teal-400/40 hover:shadow-teal-500/60',
                                                card.category.toLowerCase() === 'shopping' && 'bg-gradient-to-r from-pink-400/70 to-rose-500/80 border-pink-400 text-pink-950 shadow-pink-400/40 hover:shadow-pink-500/60'
                                            )}>
                                    ...
                                    <div className="col-span-1 md:col-span-2 mt-4">
                                        ...
                                        <ul className="flex flex-wrap gap-2">
                                            {card.features.map((f, i) => (
                                                <li
                                                    key={i}
                                                    className="bg-neutral-900/70 text-neutral-200 text-xs px-3 py-1 rounded-full border border-neutral-700 hover:border-neutral-600 transition-all duration-300 backdrop-blur-sm"
                                                >
                                                    {f}
                                                </li>
                                            ))}
